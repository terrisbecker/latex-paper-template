...
\paragraph{Budget} The total budget for the committee is \$5,100. A full breakdown of budget allocation is provided in this document. The motion to approve this document also includes a motion
to fund the committee through December 31, 2027.

\section{Approval}\label{s:approval}
After deliberation the board will appoint a committee chair and vote to approve this document along with any amendments. Approving this document funds the committee for the amount of \$7,225 through December 31, 2027. That includes the full \$5,100 for 2027 and a prorated amount of \$2,125 for August-December 2026.
...
Our role in this endeavor is as follows:
\begin{itemize}
  \item The LWC will develop a promotional pamphlet describing the services we're willing to help with: tree planting assistance, regular maintenance, and invasive species removal.
  \item The pamphlet will also contain our contact info and a link to our website with more info.
  \item Clark CD will give landowners our pamphlet when they do the initial consultation with the landowner.
  \item If the landowner is interested in our services, they will contact us and we will coordinate with them to schedule a planting or maintenance event.
  \item Clark CD will also give the LWC their promotional materials. We can distribute those to landowners while we are doing other sampling activities in the watershed.
\end{itemize}
