...
The appropriation of \$7,225 is a ceiling on what the committee may draw from the LWC's unrestricted funds, not a commitment to spend it. Any appropriated funds that remain unspent on December 31, 2027 shall return to the LWC's unrestricted funds and shall not carry over. Funding the committee beyond December 31, 2027 requires a new appropriation approved by the board.

This appropriation authorizes the committee to incur expenses within its budget; it does not give the committee chair or any project manager custody of LWC funds.
...
The following motions establish the Upper Watershed Committee as a standing committee of the LWC. They must be taken in the order given.

\subsection{Motion to Amend the LWC Charter}\label{a:motionCharter}

This motion establishes the Upper Watershed Committee as a standing committee.
...
\begin{quote}
I move that the Board appoint [\emph{name}], currently serving as [\emph{office or Director}], as Chair of the Upper Watershed Committee, to serve until the next annual meeting of the Board, and that the Board designate [\emph{name}] as an additional Director member of the committee.
\end{quote}
...
The \$5,100 annual budget comprises \$4,600 for the phosphate testing project and \$500 for the riparian restoration project.. The appropriation is a ceiling on what the committee may draw from the LWC's unrestricted funds and does not give the Chair or any project manager custody of LWC funds. Funds unspent on December 31, 2027 return to the LWC's unrestricted funds, and funding the committee beyond that date requires a new appropriation.
\end{quote}
