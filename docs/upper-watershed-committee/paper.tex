...
After deliberation the board will appoint a committee chair and vote to approve this document along with any amendments. Approving this document funds the committee for the amount of \$7,225 through December 31, 2027. That includes a prorated amount of \$2,125 for August through December 2026 and the full annual budget of \$5,100 for 2027. The funds shall be appropriated from the LWC's unrestricted funds; no restricted grant or donor-designated funds shall be used. The \$2,125 for 2026 shall be available to the committee upon approval of this document, and the \$5,100 for 2027 shall be available on January 1, 2027.

The appropriation of \$7,225 is a ceiling on what the committee may draw from the LWC's unrestricted funds, not a commitment to spend it. Any increase to the committee's budget, including a budget for the macroinvertebrate study or the budget for any project added under Section~\ref{s:amendments}, requires a separate appropriation approved by the board and shall not draw on the LWC's unrestricted funds until that appropriation is approved. Any appropriated funds that remain unspent on December 31, 2027 shall return to the LWC's unrestricted funds and shall not carry over. Funding the committee beyond December 31, 2027 requires a new appropriation approved by the board.
...
\section{List of Active Projects}\label{s:projects}
The projects listed in this section are considered active and approved under this committee upon adoption of this document. Future projects must be added through the amendment process described in Section~\ref{s:amendments}.
...
\section{Amendments and Adding Projects}\label{s:amendments}
\subsection{Amending this Document}\label{s:amendingDoc}
...
Adding a project is a major amendment and must be approved according to the process described in Section~\ref{s:amendingDoc}.
To add a project, a board member must submit a proposed amendment to Section~\ref{s:projects} of this document.
...
A project may be removed from the Upper Watershed Committee by a vote of the board. Upon approval, a board member must submit a major amendment to remove the project from Section~\ref{s:projects} of this document.

\appendix
\section{Motions for Board Approval}\label{a:motions}

The following motions establish the Upper Watershed Committee as a standing committee of the LWC. They must be taken in the order given, for the reasons below.

\paragraph{Why an amendment to the Bylaws is required} The standing committees of the LWC are enumerated in Section 5 of the LWC Charter, not in the Bylaws, so seating a new one is primarily a Charter amendment (Motion~\ref{a:motionCharter}). It also requires a Bylaws amendment, however, because of a knock-on effect in Article 7.1: the Executive Committee must include the officers of the Board and the Chair of each standing committee, and may consist of no more than nine (9) members. The Bylaws provide for five officers, and the Charter lists four standing committees other than the Executive Committee itself. That formula already reaches nine members. Seating the Chair of a fifth standing committee would push the Executive Committee to ten, exceeding the maximum, unless that Chair happens also to hold an office. Motion~\ref{a:motionBylaws} raises the maximum so that the conflict cannot arise, and is taken first so that the Executive Committee is never out of compliance with the Bylaws.

\paragraph{Why the Chair is appointed before this document is approved} Section 5 of the Charter provides that, for each standing committee, the first order of business is to appoint a Chair, and then to create a charter outlining the committee's purpose, membership, tasks, and authority, to be approved by the Board. Motions~\ref{a:motionChair} and~\ref{a:motionApprove} follow that order.

\subsection{Motion to Amend Bylaws Article 7.1}\label{a:motionBylaws}

Per Bylaws Article 10, the Bylaws may be amended only at a regular or special meeting called for that specific purpose, so the notice of the meeting must state that the Board will consider this amendment. Per Article 3.6, a quorum consisting of a majority of Board members plus one is required to amend the Bylaws, and adoption requires the affirmative vote of a majority of all Directors, not merely a majority of those present.

\begin{quote}
I move that the Board amend Bylaws Article 7.1 by striking ``not less than five (5) or more than nine (9) members'' and inserting ``not less than five (5) or more than eleven (11) members,'' so that the Executive Committee may seat the officers of the Board together with the Chair of each standing committee of the Council.
\end{quote}

\subsection{Motion to Amend the LWC Charter}\label{a:motionCharter}

This motion establishes the Upper Watershed Committee as a standing committee. It is contingent on the adoption of Motion~\ref{a:motionBylaws}.

\begin{quote}
I move that the Board amend Section 5 of the LWC Charter by adding the Upper Watershed Committee to the list of Standing Committees.
\end{quote}

\subsection{Motion to Appoint the Committee Chair}\label{a:motionChair}

Per Bylaws Article 7.2, a committee must consist of not less than two Directors, and the President is an ex officio member of each committee. Section~\ref{s:org} of this document further requires the committee chair to be a board member throughout their tenure. This motion therefore appoints the Chair and designates the additional Director required by Article 7.2.

\begin{quote}
I move that the Board appoint [\emph{name}], currently serving as [\emph{office or Director}], as Chair of the Upper Watershed Committee, to serve until the next annual meeting of the Board, and that the Board designate [\emph{name}] as an additional Director member of the committee, satisfying the two-Director minimum of Bylaws Article 7.2.
\end{quote}

\subsection{Motion to Approve this Document and its Budget}\label{a:motionApprove}

\begin{quote}
I move that the Board approve the document titled \emph{Lacamas Watershed Council Upper Watershed Committee}, dated July 2026, as the charter of the Upper Watershed Committee, and that the Board appropriate \$7,225 from the LWC's unrestricted funds to fund the committee through December 31, 2027. That appropriation comprises a prorated \$2,125 for August through December 2026, available upon adoption of this motion, and the full annual budget of \$5,100 for the 2027 calendar year, available January 1, 2027.

The \$5,100 annual budget comprises \$4,600 for the phosphate testing project and \$500 for the riparian restoration project. The macroinvertebrate study is not yet budgeted and requires a separate appropriation before the committee may incur costs for it. The appropriation is a ceiling on what the committee may draw from the LWC's unrestricted funds and does not give the Chair or any project manager custody of LWC funds. Funds unspent on December 31, 2027 return to the LWC's unrestricted funds, and funding the committee beyond that date requires a new appropriation.
\end{quote}
